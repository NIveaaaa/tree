...
inits_stan=function(){
  ...
  PI=c(1/3,1/3,1/3)
  list(mu_x=mu_x,ky=sigmay,kx=sigmax,
		#sigbeta0=sigbeta0,
		sigbeta1=sigbeta1,
       sigbeta2=sigbeta2,keta=sigmaeta,betamu0=betamu0,betamu1=betamu1,
       beta1=beta1,
	   #beta0=beta0,
	   betamu2=betamu2,PI=PI
  )
}
inits=list()
for(i in 1:3)inits[[i]] = inits_stan()

hmm.test3_2<-stan(file="hmm_test3_2.stan",data=standata,chains=3,init=inits,iter=10000)

save(hmm.test3_2,file="hmmtest3_2.Rdata")
# 
